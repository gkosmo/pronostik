class QuestionsController < ApplicationController
  ...
  before_action :set_randque, only: [:show, :searched]
  ...
  def index
    ...
    if current_user
     ...
     @limited_questions = Question.search(@search)
  end
